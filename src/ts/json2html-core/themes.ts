...
export function generateCSSCode(themeObject: any){
    let cssCode = `
/* generated by src/ts/json2html-core/themes.ts generateCSSCode() function */
    `;
...
/**
 * Generates basic style and add to document head.
 */
export function generateCoreBasicStyle(){
    const basicStyleCode = `
/* generated by src/ts/json2html-core/themes.ts generateCoreBasicStyle() function */
.json2html-pair  > *, 
...
.json2html-uncollapse-all:hover {
    ...
    const originMarker = 'json2html-basic';
    const style = document.createElement('style');
    const isNotExist = !document.head.querySelector(`[data-style-origin="${originMarker}"]`);

    if(isNotExist) {
        style.type = 'text/css';
        style.setAttribute('data-style-origin', originMarker);
        style.innerHTML = basicStyleCode;
...
export function updateThemeCSS(cssCode: string, dataMarker: string){
    ...
    const themeCSS = document.head.querySelector(dataMarker); //'[data-style-origin="json2html-theme"]'
...
export function updateTheme(themeName: string){
    ...
    if(isUserTheme){
        ...
        const dataMarker = '[data-style-origin="json2html-theme"]';
